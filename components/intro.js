...
export default function Intro() {
    ...
    return(
        <div className="flex flex-col w-full items-center justify-center">
            <Head>
                <title>werkkasten | digitalisiert</title>
            ...
            <div className="pointer-events-auto mb-12 px-4">
                <Link href="/about"><a className="font-bold block border border-2 border-werk text-werk px-6 py-4 rounded-full hover:bg-werk hover:text-white hover:shadow-2xl">Entdecken Sie Werkkasten</a></Link>
            </div>
